context('create new ad testing', () => {
  ...
  it('should create an Ad object', () => {
    ...
    cy.get('ngb-carousel img.add-picture-icon#ad-picture-0')
      .click()
      .selectFile('cypress/fixtures/images/pic-test-1-min.webp', {
        action: 'drag-drop',
      });
    cy.get('span.carousel-control-next-icon').click();
    cy.wait(2000);
    cy.get('ngb-carousel img.add-picture-icon#ad-picture-1')
      .click()
      .selectFile('cypress/fixtures/images/pic-test-2-min.webp', {
        action: 'drag-drop',
      });
